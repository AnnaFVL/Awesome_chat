...
public class SignInActivity extends AppCompatActivity {
    ...
    private TextView toggleLoginSingUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleLoginSingUp = findViewById(R.id.toggleLoginSingUp);
    ...
    private void LoginSignUpUser(String email, String password) {
        if (loginModeActive) {
            if (passwordEditText.getText().toString().trim().length() < 6) {
                Toast.makeText(this, "Password should be 6 symbols or more", Toast.LENGTH_LONG).show();
    ...
    public void toggleLogInMode(View view) {
        if (loginModeActive) {
            ...
            toggleLoginSingUp.setText("Or log in");
            repeatPasswordEditText.setVisibility(View.VISIBLE);
        } else {
            loginModeActive = true;
            loginSignUpButton.setText("Log in");
            toggleLoginSingUp.setText("Or sign up");
